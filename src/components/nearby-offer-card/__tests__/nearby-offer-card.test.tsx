...
describe('NearbyOfferCard', () => {
  ...
  it('should render correctly', () => {
    ...
    render(
      <Provider store={store}>
        <BrowserRouter>
          <NearbyOfferCard offer={mockOffer} />
        </BrowserRouter>
      </Provider>
    );
    expect(screen.getByText('Nearby Offer')).toBeInTheDocument();
  ...
  it('should show premium badge when offer is premium', () => {
    ...
    render(
      <Provider store={store}>
        <BrowserRouter>
          <NearbyOfferCard offer={premiumOffer} />
        </BrowserRouter>
      </Provider>
    );
  ...
  it('should show active favorite button when offer is favorite', () => {
    ...
    render(
      <Provider store={store}>
        <BrowserRouter>
          <NearbyOfferCard offer={favoriteOffer} />
        </BrowserRouter>
      </Provider>
    );
